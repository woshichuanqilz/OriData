...
APPS = [
    ...
    ([MOD, ALT], "v", "gvim"),
    ([MOD, ALT], "b", "google-chrome-stable"),
    ([MOD, ALT], "c", "code"),
    ([MOD, ALT], "p", "pycharm"),
    ([MOD, ALT], "a", "pavucontrol"),
    ([MOD, ALT], "e", "alacritty -e lvim .config/qtile/config.py"),
    ([MOD, ALT], "z", "zoom"),
    ...
    # Self Define key
    ([ALT], "w", f"rofi -theme '/home/lizhe/OriNote/linuxConfig/OriData/MyRofiTheme.rasi' -show-icons -combi-modi window,drun,run -show combi -modi combi -font \"Ori Iosevka 36\""),
    # ([MOD], "s", '/home/lizhe/.config/autokey/data/OriScripts/ActivateObsidian.py'),
